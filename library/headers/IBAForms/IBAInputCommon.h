...
#define IBADisplayDatePickerRequest @"DisplayDatePickerRequest"
#define IBAHideDatePickerRequest @"HideDatePickerRequest"
...
#define IBAInputDataTypeMonthYear @"IBAInputDataTypeMonthYear"
